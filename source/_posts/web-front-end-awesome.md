---
title: Web Front End Awesome (web前端实用集锦导航)
date: 2016-05-17 09:26:15
toc: true
top: 10
tags:
  - css
...
[react](https://jquery.com/) | [vue.js](http://vuejs.org) | [react-native](https://github.com/facebook/react-native) | [angular.js](http://angularjs.org) | [weex](https://weex.apache.org/) | [backbone](http://backbonejs.org)   
...
[yarn - a dependency management](https://yarnpkg.com/) | [npm - a package manager for javascript](http://www.npmjs.com/) | [grunt](http://gruntjs.com/) | [gulp](http://gulpjs.com) | [bower](http://bower.io) - package manager | [webpack](https://webpack.github.io) - a bundler for modules | [browserify](http://browserify.org/) | [FIS](https://github.com/fex-team/fis3)    
<!-- more -->
...
### Form (表单相关)  
[simple-switch](https://github.com/hiooyUI/simple-switch) | [switchery](http://abpetkov.github.io/switchery/) | [bootstrap-switch](http://www.bootstrap-switch.org/) | [jquery-validation](http://jqueryvalidation.org/) | [icheck](http://fronteed.com/iCheck) | [Parsley.js](http://parsleyjs.org) - JavaScript form validation | [wysiwyg-editor](https://github.com/froala/wysiwyg-editor) | [CKEditor](https://github.com/ckeditor/ckeditor-dev) | [alloy-editor](https://github.com/liferay/alloy-editor) | [ueditor](http://ueditor.baidu.com) | [umeditor](https://github.com/fex-team/umeditor)   
...
[jQuery-File-Upload](https://blueimp.github.io/jQuery-File-Upload/) | [fine-uploader](http://fineuploader.com) | [plupload](http://www.plupload.com/) | [uppy](https://uppy.io) | [webuploader](https://github.com/fex-team/webuploader)   
